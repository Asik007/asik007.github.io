...
export const SITE_TITLE = 'Advik S.';

export const SITE_DESCRIPTION = 'Welcome to my personal and professional website!';
...
export const CV_PDF_PATH = '\\src\\content\\cv\\cv.pdf';
